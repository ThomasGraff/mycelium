...
class DataContract(BaseModel):
    ...
    :param str dataContractSpecification: REQUIRED. Specifies the Data Contract Specification being used.
    ...
    :param ServiceLevelsObject servicelevels: Specifies the service level of the provided data.
    ...
    dataContractSpecification: str = Field(
        ..., description="REQUIRED. Specifies the Data Contract Specification being used.", pattern=r"^0\.9\.[0-3]$"
    )
    ...
    servicelevels: Optional[ServiceLevelsObject] = Field(
        None, description="Specifies the service level of the provided data."
    )
